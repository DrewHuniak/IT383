...
//	char data[] ="ABCDEFGHIJKLMNOP";
	...
	int fd = open("./my_output3.txt",  O_CREAT | O_RDWR|O_TRUNC,0666);
//	int fd = open("./my_output3.txt",   O_RDWR);
...
*/
	...
	char *ptr = (char *)mmap(NULL, 200, PROT_READ|PROT_WRITE, MAP_SHARED, fd, 0);
